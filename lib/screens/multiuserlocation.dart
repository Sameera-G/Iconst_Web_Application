...
class ShowLocationsMulti extends StatefulWidget {
  String user;
  String doc;
  ShowLocationsMulti({
    Key? key,
  ...
  @override
  State<ShowLocationsMulti> createState() => _ShowLocationsState();
}

class _ShowLocationsState extends State<ShowLocationsMulti> {
