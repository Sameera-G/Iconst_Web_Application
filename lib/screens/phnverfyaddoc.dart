...
import 'package:lconst/screens/progress_complete.dart';

class PhoneVerifiAdDoc extends StatefulWidget {
  const PhoneVerifiAdDoc({super.key, String? phNumber});

  @override
  State<PhoneVerifiAdDoc> createState() => _PhoneVerifiState();
}

String? phNumber;

class _PhoneVerifiState extends State<PhoneVerifiAdDoc> {
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    print('Mobile number is, ${phnNumber}');
                  },
                  child: Text(
                    otpCodeVisible ? 'Upload Confirm' : 'Get OTP',
    ...
    _auth.verifyPhoneNumber(
        ...
        verificationCompleted: (PhoneAuthCredential credential) async {
          if (_auth.currentUser!.phoneNumber.toString() == phNumber) {
            ...
            Fluttertoast.showToast(msg: "Files Uploaded Successfully!")
  ...
  void verifyCode() async {
    ...
    if (credential.smsCode == otpCodeController.text &&
      ...
      Fluttertoast.showToast(msg: "Locations and Photos Uploaded Successfully!")
          .catchError((error) => Fluttertoast.showToast(msg: "$error"));
    }
    /*await _auth.signInWithCredential(credential).then((value) {
      print('You are logged in');
