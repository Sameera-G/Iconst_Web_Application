...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final mobileNumberField = TextFormField(
      ...
      decoration: InputDecoration(
        ...
        contentPadding: const EdgeInsets.fromLTRB(20, 15, 20, 15),
        hintText: 'Number with +947xxxxxxx',
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(10),
        ),
      ),
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(width: width * 0.5, child: firstNameField),
                    const SizedBox(
                      height: 20.0,
                    ),
                    SizedBox(width: width * 0.5, child: secondNameField),
                    const SizedBox(
                      height: 20.0,
                    ),
                    SizedBox(width: width * 0.5, child: emailField),
                    const SizedBox(
                      height: 20.0,
                    ),
                    SizedBox(width: width * 0.5, child: homeAddressField),
                    const SizedBox(
                      height: 20.0,
                    ),
                    SizedBox(width: width * 0.5, child: mobileNumberField),
                    const SizedBox(
                      height: 20.0,
                    ),
                    SizedBox(width: width * 0.5, child: passwordField),
                    const SizedBox(
                      height: 20.0,
                    ),
                    SizedBox(width: width * 0.5, child: confirmPasswordField),
                    const SizedBox(
                      height: 20.0,
                    ),
                    SizedBox(
  ...
  postDetailsToFirestore() async {
    ...
    await firebaseFirestore
        ...
        .doc(user.uid)
        .set(userModel.toMap());
    Fluttertoast.showToast(msg: "Please Verify you Email :)");
